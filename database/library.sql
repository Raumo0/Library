...
CREATE TABLE IF NOT EXISTS `library`.`user` (
  ...
  `role_id` INT UNSIGNED NULL DEFAULT NULL COMMENT '',
  `last_update` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '',
  PRIMARY KEY (`id`, `person_id`)  COMMENT '',
...
-- -----------------------------------------------------
-- Table `library`.`author_has_book_eition`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `library`.`author_has_book_eition` (
  `author_id` INT UNSIGNED NOT NULL COMMENT '',
  `book_eition_id` INT UNSIGNED NOT NULL COMMENT '',
  `last_update` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '',
  PRIMARY KEY (`author_id`, `book_eition_id`)  COMMENT '',
  INDEX `fk_author_has_book_eition_book_eition1_idx` (`book_eition_id` ASC)  COMMENT '',
  INDEX `fk_author_has_book_eition_author1_idx` (`author_id` ASC)  COMMENT '',
  CONSTRAINT `fk_author_has_book_eition_author1`
    FOREIGN KEY (`author_id`)
    REFERENCES `library`.`author` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_author_has_book_eition_book_eition1`
